...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "D:/GIT/Git/cmd/git.exe" show-ref "master"
  WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
...
if(need_stash)
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "D:/GIT/Git/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src'."
    ...
    execute_process(
      COMMAND "D:/GIT/Git/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Studia/programowanie3D/3d-main/3d-main/out/build/x64-Debug/_deps/glfw-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
